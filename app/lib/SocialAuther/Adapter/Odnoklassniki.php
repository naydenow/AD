    ...
    public function authenticate()
    {
        ...
        if (isset($_GET['code'])) {
            ...
            if (isset($tokenInfo['access_token']) && isset($this->publicKey)) {
                $sign = md5("application_key={$this->publicKey}fields=uid,locale,first_name,last_name,gender,age,birthday,current_status,photo_id,pic_2,pic_4,pic640x480,pic1024x768,locationformat=jsonmethod=users.getCurrentUser" . md5("{$tokenInfo['access_token']}{$this->clientSecret}"));
                ...
                $params = array(
                    ...
                    'format'          => 'json',
                    'fields' => 'uid,locale,first_name,last_name,gender,age,birthday,current_status,photo_id,pic_2,pic_4,pic640x480,pic1024x768,location',
                    'sig'             => $sign
                );
